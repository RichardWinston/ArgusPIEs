...
procedure ANE_GetPIEProjectHandle(const aneHandle : ANE_PTR ;
          var pieHandle : ANE_PTR {ANE_PTR_ptr});
...
{void ANE_ExportTextFromOtherLayer(ANE_CPTR handle, ANE_CPTR layerHandle,
	...
	{ calls the layer pointed by 'layerHandle' to export its
        information into 'textExported' pointer }
...
{void ANE_ProtGetUniqueID(ANE_CPTR handle, ANE_STR uniqueIDBuf, ANE_INT32 bufLen);}
	{ return into uniqueIDBuf min(unique id  length, bufLen-1)
          characters of the Worksstation Unique ID }
...
function ANE_LayerGetHandleByIndex(const handle : ANE_PTR ; index : ANE_INT32): ANE_PTR;
...
{	/* get the given property of the layer
	...
	* Property Name		Type		    Description
	* -------------		----		    -----------
	* Name		   	kPIEString   	    Returns the layer name
