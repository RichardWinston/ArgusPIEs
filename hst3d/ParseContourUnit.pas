...
//  end;
  ...
  TContourList = class(TObject)
    ...
    public
      ...
      procedure ReadContoursFromLayer(anehandle : ANE_PTR; layerHandle : ANE_PTR);
...
begin
  ...
  result := LocalStrToFloat(AString);
end;
...
procedure TContourList.ReadContoursFromLayer(anehandle : ANE_PTR ;
  layerHandle : ANE_PTR);
var
//  ContourString : string;
//  AClipBoard : TClipboard;
