...
begin
  ...
  begin
    lblCounts.Caption := 'Colums: 0, Rows: 0, Layers: 0';
    ...
    begin
      lblCounts.Caption := Format('Colums: %d, Rows: %d, Layers: %d',
        [NCOL, NROW, NLAY]);
...
begin
  ...
  begin
    ...
    begin
      ...
      Series.Title := clbDataSets.Items[DataTypeIndex] + ' ('
        + dgCells.Cells[0, CellIndex] + ','
        + dgCells.Cells[1, CellIndex] + ','
        + dgCells.Cells[2, CellIndex] + ')';
