inherited frmZoom: TfrmZoom
  ...
  object zbMain: TRbwZoomBox
    ...
    ParentColor = False
    TabOrder = 0
    OnMouseDown = zbMainMouseDown
    OnMouseMove = zbMainMouseMove
    OnMouseUp = zbMainMouseUp
    BottomMargin = 20
    LeftMargin = 20
    RightMargin = 20
    TopMargin = 20
    MinX = 20.000000000000000000
    MaxX = 414.000000000000000000
    MinY = 20.000000000000000000
    MaxY = 270.000000000000000000
    ...
    PBDragMode = dmManual
    PBEnabled = True
    PBFont.Charset = DEFAULT_CHARSET
    PBFont.Color = clWindowText
    PBFont.Height = -11
    PBFont.Name = 'MS Sans Serif'
    PBFont.Style = []
    PBHeight = 290
    PBLeft = 0
    PBShowHint = False
