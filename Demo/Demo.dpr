...
uses
  ...
  ExportProgressUnit in 'ExportProgressUnit.pas' {frmExportProgress},
  ArgusFormUnit in '..\SHARED\ARGUSFORMUNIT.pas' {ArgusForm},
  MainForm in 'MainForm.pas' {frmMain},
  ProjectFunctions in 'ProjectFunctions.pas',
  MainLayerStructure in 'MainLayerStructure.pas',
  PieFunctionsUnit in 'PieFunctionsUnit.pas';
