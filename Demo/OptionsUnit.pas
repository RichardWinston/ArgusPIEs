...
{    Constructor Create(ModelHandle : ANE_PTR; const layerHandle : ANE_PTR;
    ...
    function NumberOfNodes(ModelHandle : ANE_PTR) : ANE_INT32;
    function GetNthNodeNumber(ModelHandle : ANE_PTR; NodeNumber : ANE_INT32) : ANE_INT32;}
    procedure GetCenter(ModelHandle : ANE_PTR; var X, Y : ANE_DOUBLE);
  end;
...
begin
  result := UGetParameterIndex(ModelHandle,FLayerHandle,ParameterName);
//  GetParameterIndex(ModelHandle, PChar(ParameterName));
end;
...
//  FreeParsedExpression(OptionsModelHandle);
  ...
  begin
    ...
    ANE_FreeParsedExpression(OptionsModelHandle,ParsedExpressionObject.ParsedExpression);
  end;
  FParsedExpression := nil;
  inherited;
end;
...
//    FreeParsedExpression(ModelHandle);
    ...
    ParsedExpressionList.AddObject(LocalExpression,ParsedExpressionObject);
  end;
end;
...
procedure TBlockObjectOptions.GetCenter(ModelHandle : ANE_PTR; var X, Y: ANE_DOUBLE);
const
  ArrayLimit = 3;
var
