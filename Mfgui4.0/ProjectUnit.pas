...
uses
  ...
  ProjectPIE, AnePIE, Forms;

procedure GetANEFunctions( var numNames : ANE_INT32;
          var descriptors : ANEPIEDescPtr ); cdecl;

function GSimpleProjectNew (Handle : ANE_PTR ; rPIEHandle :  ANE_PTR_PTR ;
...
as a tab in the template.
  ...
  frmMODFLOW := TfrmMODFLOW.Create(Application);
...
begin
	...
	gSimpleProjectPDesc.createNewProc := GSimpleProjectNew;
