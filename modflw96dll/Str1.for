C     Last change:  RBW  21 Dec 1998    5:56 pm
...
C10-----RETURN.                                                        C
     ...
     1                   NSS,NTRIB,IDIVAR,ICALC,IPTFLG,ISTRMX,IDIVARX,
     3                     ITRBARX)
C                                                                      C
C                                                                      C
...
C     -----------------------------------------------------------------C
     ...
     1          IDIVAR(NSS),ISTRMX(5,MXSTRM),ITRBARX(NSS,NTRIB),
     2          IDIVARX(NSS)
C     -----------------------------------------------------------------C
C                                                                      C
...
C      STREAM BED TO ZERO.                                             C
  ...
  360 CONTINUE
      ...
      DO I = 1, 5
        DO J = 1, MXSTRM
          ISTRMX(I,J) = ISTRM(I,J)
        END DO
      END DO
      DO I = 1, NSS
        DO J = 1, NTRIB
          ITRBARX(I,J) = ITRBAR(I,J)
        END DO
      END DO
      DO I = 1, NSS
          IDIVARX(I) = IDIVAR(I)
