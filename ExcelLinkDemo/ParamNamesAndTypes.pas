...
const   gpnSpreadSheetGrid : array [0..4] of PChar = ('SpreadSheet', 'Sheetname', 'Column', 'Row', nil);
const   g2String2IntType : array [0..4] of EPIENumberType = (kPIEString, kPIEString, kPIEInteger, kPIEInteger, 0);

const   gpnSpreadSheetContour : array [0..5] of PChar = ('SpreadSheet', 'Sheetname', 'ContourName', 'NameColumn', 'DataColumn', nil);
const   g3String2IntType : array [0..5] of EPIENumberType = (kPIEString, kPIEString, kPIEString, kPIEInteger, kPIEInteger, 0);
