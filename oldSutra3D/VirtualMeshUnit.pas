...
uses SysUtils, classes, Math, AnePIE, IntListUnit, VertexUnit, OptionsUnit,
  doublePolyhedronUnit, Dialogs;
...
//      FNodeIndex : integer;
    ...
    public
      ...
      NodeIndex : integer;
      Comment : string;
//      Constructor Create(LayerAbove, LayerBelow : TReal2DMesh);
...
//      PolyHedron : TPolyhedron;
    ...
    public
      ...
      Destructor Destroy; override;
//      function BooleanParameterValue(ParameterIndexAbove, ParameterIndexBelow : ANE_INT16) : ANE_BOOL;
//      function IntegerParameterValue(ParameterIndexAbove, ParameterIndexBelow : ANE_INT16) : ANE_INT32;
//      function RealParameterValue(ParameterIndexAbove, ParameterIndexBelow : ANE_INT16) : ANE_DOUBLE;
...
{    procedure GetMorphedFraction(LayerAbove, LayerBelow: TReal2dMesh;
  ...
  Public
    ...
    // given it's virtual layer and position on the layer.
...
//    procedure ParseInitialPressure;
//    procedure ParseInitialConcentration;
...
uses SLSutraMesh, ANECB, SegmentUnit, TriangleUnit, SLMorphLayer, SolidGeom,
  ZFunction, frmSutraUnit, VirtualMeshFunctions;
...
{  LowIndex := 0;
  ...
  begin
    MidIndex := (HighIndex + LowIndex) div 2;
    ANode := SortedMinListOfNodes[MidIndex];
    if ANode.PolyHedron.bmin[Dimension] > Max then
    begin
      LowIndex := MidIndex;
    end
    else
...
begin
  ...
  ParameterIndex := ANE_LayerGetParameterByName(ModelHandle,
         FMesh.FLayerHandle, PChar( parameterName ));
...
constructor TVirtual3DMesh.Create(ModelHandle: ANE_PTR;
  Discretization: TIntegerList; MorphMesh : T3DMorphMesh);
var
  Index : integer;
begin
  ...
  begin
    ...
    begin
      try
        ...
        ShowMessage('Error creating polyhedron for Node ' + IntToStr(NodeIndex));
        raise;
      end;
    end;
  end
  ...
  begin
    ...
    begin
      try
        ...
        ShowMessage('Error readin polyhedron for Node ' + IntToStr(NodeIndex));
        raise;
      end;
    end;
  end;
...
var
  ...
  Node : TVirtualNode;
  LayerAbove, LayerBelow : TReal2DMesh;
  MorphLayerAbove, MorphLayerBelow : TReal2DMesh;
...
begin
  ...
  begin
    ...
    begin
      ...
      begin
        Node := TVirtualNode.Create(NodeList.Count);
        NodeList.Add(Node);
        Inc(NodeEnd);
//        with Node do
//        begin
...
begin
  ...
  if (N = '0') then
  begin
    LayerName := LayerName + IntToStr(LayerIndex);
  end;
...
begin
  ...
  CornerIndex := APolyHedron.VertexIndex(Corner,LastVertex);
...
//    LastVertex := 0;
  ...
  ElementCenterIndex := APolyHedron.VertexIndex(ElementCenter,LastVertex);
  ...
  try
    ...
    begin
      ...
      begin
        ...
        FaceCenterIndex := APolyHedron.VertexIndex(FaceCenter,LastVertex);
        ...
        EdgeCenterIndex1 := APolyHedron.VertexIndex(EdgeCenter,LastVertex);
        ...
        EdgeCenterIndex2 := APolyHedron.VertexIndex(EdgeCenter,LastVertex);
