...
function WriteSutraPostProcessing(aneHandle : ANE_PTR; NamesList,
          ...
          var maplayerhandle : ANE_PTR; DrawAxes : boolean) : string ;
...
uses dialogs, ANECB, FixNameUnit, LayerNamePrompt;
