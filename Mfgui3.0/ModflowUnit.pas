...
//    function GetMFLayerStructure : TMFLayerStructure; virtual;
    ...
    procedure ReadOldGeoData(var LineIndex : integer; FirstList, IgnoreList: TStringlist;
      DataToRead : TStringList; const VersionControl : TControl); virtual;
    procedure ReadOldIDIREC(var LineIndex : integer; FirstList, IgnoreList: TStringlist;
      DataToRead : TStringList; const VersionControl : TControl); virtual;
    procedure ReadEPSSLV(var LineIndex : integer; FirstList, IgnoreList: TStringlist;
      DataToRead : TStringList; const VersionControl : TControl); virtual;
    procedure ReadCTOCH(var LineIndex : integer; FirstList, IgnoreList: TStringlist;
      DataToRead : TStringList; const VersionControl : TControl); virtual;
...
{$ENDIF}
    ...
    ContourListUnit, MOC3DGridFunctions, OptionsUnit;
...
//  packages.
  ...
  // depending on whether MOC3D is selected.
  MFLayerStructure.UnIndexedLayers.AddOrRemoveIndexedParameter1
    (ModflowTypes.GetGridLayerType, ModflowTypes.GetMFGridMOCPrescribedConcParamType,
     cbMOC3D.Checked);
...
{                For ColIndex := 0 to dtabGeol.ColumnSet.Count -1 do
                ...
                if not (Sender = btnInsertUnit) and not Cancelling then
                begin
            ...
            begin
              ...
              begin
                  if not (Sender = btnDeleteUnit) and not Cancelling then
                  begin
          ...
          then
            ...
            begin
              ...
              begin
                ...
                // being deleted
                For RowIndex := sgTime.RowCount -1 downto NewNumPeriods + 1 do
                begin
...
procedure TfrmMODFLOW.ReadOld_IDPTIM(var LineIndex : integer; FirstList, IgnoreList: TStringlist;
    DataToRead : TStringList; const VersionControl : TControl);
var
  Line : integer;
begin
  Line := LineIndex;
  ReadCheckBox(LineIndex, FirstList, IgnoreList, cbIDPTIM_Decay, DataToRead, VersionControl);
  LineIndex := Line;
  ReadCheckBox(LineIndex, FirstList, IgnoreList, cbIDPTIM_Growth, DataToRead, VersionControl);
end;

procedure TfrmMODFLOW.ReadOld_IDKTIM(var LineIndex : integer; FirstList, IgnoreList: TStringlist;
    DataToRead : TStringList; const VersionControl : TControl);
var
  Line : integer;
begin
  Line := LineIndex;
  ReadCheckBox(LineIndex, FirstList, IgnoreList, cbIDKTIM_DisDecay, DataToRead, VersionControl);
  LineIndex := Line;
  ReadCheckBox(LineIndex, FirstList, IgnoreList, cbIDKTIM_SorbDecay, DataToRead, VersionControl);
  LineIndex := Line;
  ReadCheckBox(LineIndex, FirstList, IgnoreList, cbIDKTIM_DisGrowth, DataToRead, VersionControl);
  LineIndex := Line;
  ReadCheckBox(LineIndex, FirstList, IgnoreList, cbIDKTIM_SorbGrowth, DataToRead, VersionControl);
end;

procedure TfrmMODFLOW.ReadOldGeoData(var LineIndex : integer; FirstList, IgnoreList: TStringlist;
    DataToRead : TStringList; const VersionControl : TControl);
var
...
procedure TfrmMODFLOW.ReadOldIDIREC(var LineIndex : integer; FirstList, IgnoreList: TStringlist;
    DataToRead : TStringList; const VersionControl : TControl);
var
  AText : string;
  AnInteger : integer;
...
procedure TfrmMODFLOW.ReadEPSSLV(var LineIndex : integer; FirstList, IgnoreList: TStringlist;
    DataToRead : TStringList; const VersionControl : TControl);
var
  AText : string;
  AFloat : double;
...
procedure TfrmMODFLOW.ReadCTOCH (var LineIndex : integer; FirstList, IgnoreList: TStringlist;
      DataToRead : TStringList; const VersionControl : TControl);
