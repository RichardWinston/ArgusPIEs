...
begin
  ...
  try
//    layerHandle := ANE_LayerGetHandleByName(aneHandle, 'SUTRA Post Processing Charts1');
    ANE_ExportTextFromOtherLayer(aneHandle, layerHandle, @Chart );
//    Chart := String(textExported^);
    Form1.Memo1.Text := Chart;
    Form1.ShowModal;
  finally
    Form1.Free;
  end;
...
begin
	...
	gDelphiPIEImportPIEDesc.name := 'Simple Import Delphi Pie';   // name of project
	gDelphiPIEImportPIEDesc.importFlags := kImportFromLayer;
 	gDelphiPIEImportPIEDesc.fromLayerTypes := (kPIEMapsLayer) {* was kPIETriMeshLayer*/};
	...
	gDelphiPIEDesc.name := 'Simple Import Delphi Pie';      // PIE name
