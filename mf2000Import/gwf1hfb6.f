...
C     READ BARRIERS NOT DEFINED BY PARAMETERS (ITEM 4)
     ...
     &        WRITE(IOUT,530)I,LAYER,IROW1,ICOL1,IROW2,ICOL2,HYDCHR
          ...
          HFB(7,I) = 0.0
c rbw begin change
          CALL ReadNewHFB(HFB_Param, LAYER,IROW1,ICOL1,
     1       IROW2,ICOL2,HYDCHR)
c rbw end change
   30   CONTINUE
...
C  Read the non-optional values from a line.
      ...
      FACTOR = FACTOR*SFAC
c rbw begin change
      CALL ReadNewHFB(IsParam, K,I1,J1,I2,J2,FACTOR)
c rbw end change
C
