...
uses Classes, OptionsUnit, SLUnsaturated, VirtualMeshUnit, frmSutraUnit,
  ...
  ParamArrayUnit, UtilityFunctions, ZFunction;
...
begin
  ...
  begin
    ...
    try
      ...
      for RealLayerIndex := 0 to frmSutra.VirtualMesh.RealMeshCount-2 do
      begin
        UnsatLayerName := TUnsaturatedLayer.WriteNewRoot
          + IntToStr(RealLayerIndex+1);
        LayerHandle := GetLayerHandle(funHandle, UnsatLayerName);
      ...
      begin
        ...
        begin
          ...
          CurrentElement := AVirtElement;
//          RealIndex := frmSutra.VirtualMesh.RealLayerIndex(VirtLayerIndex);
          RealLayerIndex := frmSutra.VirtualMesh.RealLayerIndex(VirtLayerIndex);
...
begin
  ...
  begin
    ...
    try
      ...
      begin
        LayerList.Add(LayerList[LayerList.Count-1]);
      end;
      ...
      begin
        ...
        begin
          ...
          CurrentVertex := AVirtNode;
//          RealIndex := frmSutra.VirtualMesh.RealLayerIndex(VirtLayerIndex);
          RealLayerIndex := frmSutra.VirtualMesh.RealLayerIndex(VirtLayerIndex);
          assert(RealLayerIndex  < frmSutra.VirtualMesh.RealMeshCount);
          assert(RealLayerIndex >=0);
//          for RealLayerIndex := RealIndex to RealIndex + 1 do
...
//          end;
      ...
      for RealLayerIndex := 0 to LayerList.Count -2 do
      begin
        UnsatZoneLayer := LayerList[RealLayerIndex];
        UnsatZoneLayer.Free(funHandle);
      end;
