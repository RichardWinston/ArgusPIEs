...
type
  ...
  TQIN_CommentParam = class(TAlwaysNodeParameter)
    class function ANE_ParamName: string; override;
    function Value: string; override;
    constructor Create(AParameterList: T_ANE_ParameterList;
      Index: Integer = -1); override;
  ...
  TCustomTimeDepParam = class(TNodeParameter)
  protected
    class function TwoDValue(const LayerName: string): string;
  end;

  TCustomOverContourTimeDepParam = class(TNodeParameter)
  protected
    class function TwoDValue(const LayerName: string): string;
  end;

  TTimeDepFluidSourceParam = class(TCustomTimeDepParam)
    class function ANE_ParamName: string; override;
    constructor Create(AParameterList: T_ANE_ParameterList;
      Index: Integer = -1); override;
    function Value: string; override;
  ...
  TTimeDepEnergySoluteSourceParam = class(TCustomTimeDepParam)
    class function ANE_ParamName: string; override;
    constructor Create(AParameterList: T_ANE_ParameterList;
      Index: Integer = -1); override;
    function Value: string; override;
  ...
  TTimeDepSpecHeadPresParam = class(TCustomOverContourTimeDepParam)
    class function ANE_ParamName: string; override;
    constructor Create(AParameterList: T_ANE_ParameterList;
      Index: Integer = -1); override;
    function Value: string; override;
  ...
  TTimeDepSpecConcTempParam = class(TCustomOverContourTimeDepParam)
    class function ANE_ParamName: string; override;
    constructor Create(AParameterList: T_ANE_ParameterList;
      Index: Integer = -1); override;
    function Value: string; override;
  ...
  TPVEC_OverrideParam = class(TNodeParameter)
    class function ANE_ParamName: string; override;
    function Units: string; override;
    function Value: string; override;
  end;
  ...
  TUVEC_OverrideParam = class(TNodeParameter)
    class function ANE_ParamName: string; override;
    function Units: string; override;
    function Value: string; override;
    class function UsualValue: string;
...
resourcestring
  ...
  kPVEC = 'PVEC';
  kPVEC_Override = 'PVEC_Override';
  kUVEC = 'UVEC';
  kUVEC_Override = 'UVEC_Override';
  kINOB = 'INOB';
  kObsType = 'ObsType';
...
begin
  ...
  begin
    ParentIndexString := WriteParentIndex;
    if (ParentIndexString = '1') or (ParentIndexString = '') then
    begin
      result := TwoDValue(TTopFluidSourcesLayer.WriteNewRoot);
...
//        + TTimeDependanceParam.WriteParamName;
    ...
    begin
      ParentIndexString := IntToStr(StrToInt(ParentIndexString) - 1);
      result := TwoDValue(TBottomFluidSourcesLayer.WriteNewRoot + ParentIndexString);
...
//        + TTimeDependanceParam.WriteParamName;
  ...
  begin
    result := TwoDValue(T2DFluidSourcesLayer.WriteNewRoot + WriteParentIndex);
...
begin
  Result := TwoDValue(T2DSoluteEnergySourcesLayer.WriteNewRoot);
...
begin
  ...
  begin
    ...
    if (ParentIndexString = '1') or (ParentIndexString = '') then
    begin
      Result := TwoDValue(TTopSoluteEnergySourcesLayer.WriteNewRoot);
...
//        + TTimeDependanceParam.WriteParamName;
    ...
    begin
      ParentIndexString := IntToStr(StrToInt(ParentIndexString) - 1);
      Result := TwoDValue(TBottomSoluteEnergySourcesLayer.WriteNewRoot + ParentIndexString);
...
//        + '.' + TTimeDependanceParam.WriteParamName;
  ...
  begin
    Result := TwoDValue(T2DSoluteEnergySourcesLayer.WriteNewRoot + WriteParentIndex);
...
begin
  ...
  begin
    ...
    if (ParentIndexString = '1') or (ParentIndexString = '') then
    begin
      result := TwoDValue(TTopSpecifiedPressureLayer.WriteNewRoot);
//      result := TTopSpecifiedPressureLayer.WriteNewRoot + '.'
//        + TTimeDependanceParam.WriteParamName;
    end
    else
    begin
      ParentIndexString := IntToStr(StrToInt(ParentIndexString) - 1);
      result := TwoDValue(TBottomSpecifiedPressureLayer.WriteNewRoot + ParentIndexString);
//      result := TBottomSpecifiedPressureLayer.WriteNewRoot + ParentIndexString +
//        '.' + TTimeDependanceParam.WriteParamName;
    end;
  end
  ...
  begin
    result := TwoDValue(T2DSpecifiedPressureLayer.WriteNewRoot + WriteParentIndex);
//    result := T2DSpecifiedPressureLayer.WriteNewRoot + WriteParentIndex + '.'
//      + TTimeDependanceParam.WriteParamName;
  end;
end;
...
begin
  result := TwoDValue(T2DSpecConcTempLayer.WriteNewRoot);
...
begin
  ...
  begin
    ...
    if (ParentIndexString = '1') or (ParentIndexString = '') then
    begin
      result := TwoDValue(TTopSpecConcTempLayer.WriteNewRoot);
...
//        + TTimeDependanceParam.WriteParamName;
    ...
    begin
      ParentIndexString := IntToStr(StrToInt(ParentIndexString) - 1);
      result := TwoDValue(TBottomSpecConcTempLayer.WriteNewRoot + ParentIndexString);
...
//        + TTimeDependanceParam.WriteParamName;
  ...
  begin
    result := TwoDValue(T2DSpecConcTempLayer.WriteNewRoot + WriteParentIndex);
...
begin
  ...
  ParameterOrder.Add(TQIN_CommentParam.ANE_ParamName);
  ...
  ParameterOrder.Add(TPVEC_OverrideParam.ANE_ParamName);
  ParameterOrder.Add(TUVECParam.ANE_ParamName);
  ParameterOrder.Add(TUVEC_OverrideParam.ANE_ParamName);
  ...
  begin
    ...
    begin
      ...
      if frmSutra.cbPressureOverride.Enabled
        and frmSutra.cbPressureOverride.Checked then
      begin
        TPVEC_OverrideParam.Create(self, -1);
      end;
...
begin
  ...
  ParamList.ParameterOrder.Add(TQIN_CommentParam.ANE_ParamName);
  ...
  ParamList.ParameterOrder.Add(TPVEC_OverrideParam.ANE_ParamName);
  ParamList.ParameterOrder.Add(TUVECParam.ANE_ParamName);
  ParamList.ParameterOrder.Add(TUVEC_OverrideParam.ANE_ParamName);
...
//  ParamList.ParameterOrder.Add(TInvNodeFunctionUBC_Param.ANE_ParamName);
  ...
  begin
    ...
    begin
      ...
      TQIN_CommentParam.Create(ParamList, -1);
      if frmSutra.Is3D then
      begin
...
class function TQIN_CommentParam.ANE_ParamName: string;
begin
  result := kQIN_Comment;
end;

constructor TQIN_CommentParam.Create(AParameterList: T_ANE_ParameterList;
  Index: Integer);
begin
  inherited;
  ValueType := pvString;
...
function TQIN_CommentParam.Value: string;
var
  ParentIndexString: string;
begin
  if frmSutra.Is3D then
...
class function TCustomTimeDepParam.TwoDValue(const LayerName: string): string;
var
  ParameterName: string;
begin
  ParameterName := TTimeDependanceParam.WriteParamName;
  result := Format('Index(NodeAboveCntr(%0:s)+1, NodeEffectiveValue(%0:s.%1:s)>0, '
    + '%0:s.%1:s, %0:s.%1:s*NodeEffectiveLength(%0:s)>0, '
    + 'NodeEffectiveValue(%0:s.%1:s)>0, NodeEffectiveValue(%0:s.%1:s)>0)',
    [LayerName, ParameterName]);
end;

{ TCustomOverContourTimeDepParam }

class function TCustomOverContourTimeDepParam.TwoDValue(
  const LayerName: string): string;
begin
  result := Format('if(NodeAboveCntr(%0:s),%0:s.%1:s,0)',
    [LayerName, TTimeDependanceParam.WriteParamName]);
end;

{ TPVEC_OverrideParam }

class function TPVEC_OverrideParam.ANE_ParamName: string;
begin
  result := kPVEC_Override;
end;

function TPVEC_OverrideParam.Units: string;
begin
  case frmSutra.StateVariableType of
    svPressure:
      begin
...
function TPVEC_OverrideParam.Value: string;
begin
  result := TInitialPressureOverrideLayer.WriteNewRoot + WriteParentIndex + '.'
    + TInitialPressureOverrideParam.WriteParamName
end;

{ TUVEC_OverrideParam }

class function TUVEC_OverrideParam.ANE_ParamName: string;
begin
  result := kUVEC_Override;
end;

function TUVEC_OverrideParam.Units: string;
begin
  case frmSutra.TransportType of
    ttGeneral:
      begin
...
class function TUVEC_OverrideParam.UsualValue: string;
begin
  result := TInitialConcTempOverrideLayer.WriteNewRoot + '.'
    + TInitialConcTempOverrideParam.WriteParamName;
end;

function TUVEC_OverrideParam.Value: string;
begin
  result := TInitialConcTempOverrideLayer.WriteNewRoot + WriteParentIndex + '.'
    + TInitialConcTempOverrideParam.WriteParamName;
end;
