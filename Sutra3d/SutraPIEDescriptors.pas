...
//  gSutraParameterFormatPieDesc         : ANEPIEDesc;
  ...
  gSutraPathFunctionPieDesc : FunctionPIEDesc;
  gSutraPathPieDesc         : ANEPIEDesc;

  gSutraRestartPathFunctionPieDesc : FunctionPIEDesc;
  gSutraRestartPathPieDesc         : ANEPIEDesc;

  gSutraRootPathFunctionPieDesc : FunctionPIEDesc;
  gSutraRootPathPieDesc         : ANEPIEDesc;

  gSutraCopyRestartPathFunctionPieDesc : FunctionPIEDesc;
  gSutraCopyRestartPathPieDesc         : ANEPIEDesc;
