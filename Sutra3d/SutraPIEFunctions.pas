...
//  gSutraDataSet11BFunctionPieDesc.paramTypes := @gOneStringTypes;                      // parameter types
  ...
  gSutraPathFunctionPieDesc.version := FUNCTION_PIE_VERSION;       // Function PIE verions
  gSutraPathFunctionPieDesc.functionFlags := UsualOptions ;   // Function options
  gSutraPathFunctionPieDesc.name := 'SUTRA_Path';               // Function name
  gSutraPathFunctionPieDesc.address := GetSutraPath;                 // Function address
  gSutraPathFunctionPieDesc.returnType := kPIEString;              // return type
  gSutraPathFunctionPieDesc.numParams := 0;                       // number of parameters;
  gSutraPathFunctionPieDesc.numOptParams := 0;                      // number of optional parameters;
//  gSutraPathFunctionPieDesc.paramNames := @gpnFile;                     // paramter names
//  gSutraPathFunctionPieDesc.paramTypes := @gOneStringTypes;                      // parameter types
  gSutraPathFunctionPieDesc.neededProject := Project;               // needed project

  gSutraPathPieDesc.version := ANE_PIE_VERSION;             // Function Pie version
  gSutraPathPieDesc.vendor :=  Vendor;                           // vendor
  gSutraPathPieDesc.product := Product;                          // product
  gSutraPathPieDesc.name  := 'SUTRA_Path';                            // function name
  gSutraPathPieDesc.PieType :=  kFunctionPIE;                    // Pie type
  gSutraPathPieDesc.descriptor := @gSutraPathFunctionPieDesc;         // function PIE descriptor address

  Assert(numNames < kMaxPIEDesc);
  gPIEDesc[numNames] := @gSutraPathPieDesc;                      // add descriptor to list
  Inc(numNames); 	                                             // increment number of names
  ...
  gSutraRestartPathFunctionPieDesc.version := FUNCTION_PIE_VERSION;       // Function PIE verions
  gSutraRestartPathFunctionPieDesc.functionFlags := UsualOptions ;   // Function options
  gSutraRestartPathFunctionPieDesc.name := 'SUTRA_RestartPath';               // Function name
  gSutraRestartPathFunctionPieDesc.address := GetSutraRestartPath;                 // Function address
  gSutraRestartPathFunctionPieDesc.returnType := kPIEString;              // return type
  gSutraRestartPathFunctionPieDesc.numParams := 0;                       // number of parameters;
  gSutraRestartPathFunctionPieDesc.numOptParams := 0;                      // number of optional parameters;
//  gSutraPathFunctionPieDesc.paramNames := @gpnFile;                     // paramter names
//  gSutraPathFunctionPieDesc.paramTypes := @gOneStringTypes;                      // parameter types
  gSutraRestartPathFunctionPieDesc.neededProject := Project;               // needed project

  gSutraRestartPathPieDesc.version := ANE_PIE_VERSION;             // Function Pie version
  gSutraRestartPathPieDesc.vendor :=  Vendor;                           // vendor
  gSutraRestartPathPieDesc.product := Product;                          // product
  gSutraRestartPathPieDesc.name  := 'SUTRA_RestartPath';                            // function name
  gSutraRestartPathPieDesc.PieType :=  kFunctionPIE;                    // Pie type
  gSutraRestartPathPieDesc.descriptor := @gSutraRestartPathFunctionPieDesc;         // function PIE descriptor address

  Assert(numNames < kMaxPIEDesc);
  gPIEDesc[numNames] := @gSutraRestartPathPieDesc;                      // add descriptor to list
  Inc(numNames); 	                                             // increment number of names


  gSutraRootPathFunctionPieDesc.version := FUNCTION_PIE_VERSION;       // Function PIE verions
  gSutraRootPathFunctionPieDesc.functionFlags := UsualOptions ;   // Function options
  gSutraRootPathFunctionPieDesc.name := 'SUTRA_Root';               // Function name
  gSutraRootPathFunctionPieDesc.address := GetSutraRootPath;                 // Function address
  gSutraRootPathFunctionPieDesc.returnType := kPIEString;              // return type
  gSutraRootPathFunctionPieDesc.numParams := 0;                       // number of parameters;
  gSutraRootPathFunctionPieDesc.numOptParams := 0;                      // number of optional parameters;
//  gSutraPathFunctionPieDesc.paramNames := @gpnFile;                     // paramter names
//  gSutraPathFunctionPieDesc.paramTypes := @gOneStringTypes;                      // parameter types
  gSutraRootPathFunctionPieDesc.neededProject := Project;               // needed project

  gSutraRootPathPieDesc.version := ANE_PIE_VERSION;             // Function Pie version
  gSutraRootPathPieDesc.vendor :=  Vendor;                           // vendor
  gSutraRootPathPieDesc.product := Product;                          // product
  gSutraRootPathPieDesc.name  := 'SUTRA_Root';                            // function name
  gSutraRootPathPieDesc.PieType :=  kFunctionPIE;                    // Pie type
  gSutraRootPathPieDesc.descriptor := @gSutraRootPathFunctionPieDesc;         // function PIE descriptor address

  Assert(numNames < kMaxPIEDesc);
  gPIEDesc[numNames] := @gSutraRootPathPieDesc;                      // add descriptor to list
  Inc(numNames); 	                                             // increment number of names


  gSutraCopyRestartPathFunctionPieDesc.version := FUNCTION_PIE_VERSION;       // Function PIE verions
  gSutraCopyRestartPathFunctionPieDesc.functionFlags := UsualOptions ;   // Function options
  gSutraCopyRestartPathFunctionPieDesc.name := 'SUTRA_CopyPath';               // Function name
  gSutraCopyRestartPathFunctionPieDesc.address := GetSutraCopyRestartPath;                 // Function address
  gSutraCopyRestartPathFunctionPieDesc.returnType := kPIEString;              // return type
  gSutraCopyRestartPathFunctionPieDesc.numParams := 0;                       // number of parameters;
  gSutraCopyRestartPathFunctionPieDesc.numOptParams := 0;                      // number of optional parameters;
//  gSutraPathFunctionPieDesc.paramNames := @gpnFile;                     // paramter names
//  gSutraPathFunctionPieDesc.paramTypes := @gOneStringTypes;                      // parameter types
  gSutraCopyRestartPathFunctionPieDesc.neededProject := Project;               // needed project

  gSutraCopyRestartPathPieDesc.version := ANE_PIE_VERSION;             // Function Pie version
  gSutraCopyRestartPathPieDesc.vendor :=  Vendor;                           // vendor
  gSutraCopyRestartPathPieDesc.product := Product;                          // product
  gSutraCopyRestartPathPieDesc.name  := 'SUTRA_CopyPath';                            // function name
  gSutraCopyRestartPathPieDesc.PieType :=  kFunctionPIE;                    // Pie type
  gSutraCopyRestartPathPieDesc.descriptor := @gSutraCopyRestartPathFunctionPieDesc;         // function PIE descriptor address

  Assert(numNames < kMaxPIEDesc);
  gPIEDesc[numNames] := @gSutraCopyRestartPathPieDesc;                      // add descriptor to list
  Inc(numNames); 	                                             // increment number of names
