...
function GGetCrossColumnCompositeLength(ListIndex, CellIndex : ANE_INT32): ANE_DOUBLE;
...
function GGetCountOfCrossColumnLists : ANE_INT32;
begin
  if not (CrossColumnCellsList = nil)
  then
    begin
    ...
    begin
      ...
      begin
        ...
        if AnotherCell.SegmentSecondVertexYPos
          (AnotherCell.SegmentList.Count -1) > AnotherCell.RowCenter
        then
          begin
