...
var
  AReal : TReal;
begin
  AReal := ColumnMiddleList.Items[Column];
  result := AReal.Value;
end;
...
begin
  AReal := ColumnList.Items[Column];
  AnotherReal := ColumnList.Items[Column-1];
  result := AReal.Value-AnotherReal.Value;
  AReal := RowList.Items[Row];
  AnotherReal := RowList.Items[Row-1];
  result := Abs(result*(AReal.Value-AnotherReal.Value));
end;
