...
{
procedure ANE_GetVersion(aneHandle : ANE_PTR ; major : ANE_INT32_PTR ; minor : ANE_INT32_PTR ; update : ANE_INT32_PTR ; versionBuf : ANE_STR ; bufLen : ANE_INT32 );
...
{void ANE_EvaluateStringAtLayer(ANE_PTR handle, ANE_PTR layerHandle, enum EPIENumberType type, ANE_STR string, ANE_PTR result);}
