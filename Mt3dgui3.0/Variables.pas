...
uses GetTypesUnit, ModflowUnit, RunUnit, PostMODFLOW, SelectPostFile,
  MT3DFormUnit, GetMT3DTypes, RunMT3DUnit, WellDataUnit, WarningsUnit,
  WellMt3dData;
...
//    MFGUI_30.dpr, GetANEFunctionsUnit.pas and this file.
//    All other changes should be done in new files.
...
initialization
begin
  ModflowTypes := TMT3DTypesClass.Create;
end;
